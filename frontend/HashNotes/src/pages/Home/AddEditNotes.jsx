  ...
  return (
    <div className='relative p-3'>
        ...
        <div className='flex flex-col gap-2 mt-4'>
            ...
            <textarea
                type='text' 
                className='text-xs sm:text-sm md:text-base lg:text-lg text-slate-950 dark:text-neutral-100 dark:placeholder:text-neutral-400 outline-none bg-slate-100 dark:bg-neutral-700 border rounded-md border-slate-300 dark:border-neutral-700 p-2 sm:p-3 md:p-4 overflow-y-scroll overscroll-contain '
