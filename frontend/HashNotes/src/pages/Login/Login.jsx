  ...
  return (
    <div className='min-h-screen min-w-screen flex flex-col bg-gray-100 dark:bg-neutral-900'>
        ...
        <div className={`flex items-center justify-center flex-grow select-none `}>
            <div className='w-96 md:w-[450px] bg-white dark:bg-neutral-800 border dark:border-none rounded-md  dark:border-neutral-400 shadow-md shadow-gray-300 dark:shadow-none px-7 py-10 m-6 mt-[150px]'>
